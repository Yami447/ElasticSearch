package com.elastic.elasticsearch.query;

import co.elastic.clients.elasticsearch.ElasticsearchClient;
import co.elastic.clients.elasticsearch.core.*;
import co.elastic.clients.elasticsearch.core.search.Hit;
import com.elastic.elasticsearch.model.Product;
...
public class ElasticsearchQuery {
    ...
    public String createOrUpdateDocument(Product product) throws IOException {
        ...
        IndexResponse response = elasticsearchClient.index(i -> i
                ...
                .id(product.getId())
                .document(product)
        );  //here we are telling elasticsearchClient to performa  indexing operation (i.e. adding/ updating a
        // document), so we provide it the index name, the id of the docuement and the value that is to be added
        // (product)
        //Then we observe the response and print the message accordingly
